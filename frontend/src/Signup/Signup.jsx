...
function Signup() {
    ...
    const signup = async (e) => {
        const payload = { name: name.current.value, username: username.current.value, password: password.current.value };
        console.log(payload);
        try {
                    ...
                    <Card className="mt-3 p-3 signup">
                        ...
                        <Card.Body>
                            ...
                            <Form.Group className="mb-3" controlId="formBasicPassword">
                                ...
                                <Form.Control type="password" onChange={validatePasword} placeholder="Password" ref={password} />
                            </Form.Group>
                            <Button variant="primary" type="submit" disabled={!isValid} onClick={signup}>
                                Signup
                            </Button>
                        </Card.Body>
